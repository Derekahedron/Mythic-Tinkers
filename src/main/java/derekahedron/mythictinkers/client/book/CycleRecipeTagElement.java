...
public class CycleRecipeTagElement extends ArrowElement {

    public CycleRecipeTagElement(int x, int y, ArrowButton.ArrowType arrowType, int arrowColor, int arrowColorHover, ContentModifierTag modifiers, BookData book, ArrayList<BookElement> list) {
        super(x, y, arrowType, arrowColor, arrowColorHover, (button) -> modifiers.nextRecipe(book, list));
    }
